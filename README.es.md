...
1. ¿Cómo aplicar Tailwind CSS a tu sitio web?

2. Seleccionar elementos HTML de tu sitio web para aplicar las clases de utilidad de Tailwind.

3. Aplicar clases de utilidad de Tailwind a esos elementos.

4. Uso de los patrones de utilidad más populares de Tailwind.

5. Diseño responsivo con Tailwind CSS.
<!-- hide -->
...
<ol>
  ...
  <li><a href="https://github.com/4GeeksAcademy/tailwind-exercises-tutorial">Aprender Tailwind CSS</a>← 🔥 Estás aquí</li>
</ol>

Una completa selección de ejercicios autograduados sobre Tailwind CSS ¡para cualquier interesado en aprender Tailwind!

## Instalación en un clic (recomendado)

Puedes empezar estos ejercicios en pocos segundos haciendo clic en: [Abrir en Codespaces](https://codespaces.new/?repo=4GeeksAcademy/tailwind-exercises-tutorial) (recomendado) o [Abrir en Gitpod](https://gitpod.io#https://github.com/4GeeksAcademy/tailwind-exercises-tutorial).
